...
- **For the fleet/profiles:** worker run metadata should make usage reporting mandatory, not best-effort; three silent working runs is a board defect, not a worker defect.
